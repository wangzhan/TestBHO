========================================================================
    ACTIVE TEMPLATE LIBRARY : TestBHO Project Overview
========================================================================

AppWizard has created this TestBHO project for you to use as the starting point for
...
TestBHO.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (TestBHO.h)
        GUID definitions                                (TestBHO_i.c)
        A type library                                  (TestBHO.tlb)
        Marshaling code                                 (TestBHO_p.c and dlldata.c)

TestBHO.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in TestBHO.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named TestBHO.pch and a precompiled types file named StdAfx.obj.
...
TestBHOps.vcproj
	...
	dlldata.c, TestBHO_i.c and TestBHO_p.c which are required
